...
#import frames
import welcome_page_frame, menu_frame, info_frame, textbook_scanner_frame, teacher_assignment_frame, textbook_management_frame
...
class client(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.scene_list = (welcome_page_frame.WelcomePage, menu_frame.Menu, textbook_management_frame.TextbookManagement, info_frame.Info, textbook_scanner_frame.TextbookScanner, teacher_assignment_frame.TeacherAssignment)
