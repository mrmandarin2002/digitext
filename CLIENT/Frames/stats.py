...
class Stats(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.ip_address_label = tk.Label(self, text = "IP ADDRESS: " + str(controller.settings["ip_address"]), font = controller.ENTRY_FONT, bg = controller.MAROON)
        self.ip_address_label.pack(side = "top", pady = 2, padx = 0)
        self.welcome_title = tk.Label(self, text = "Number Of Textbooks: ", font = controller.TITLE_FONT2 , bg = controller.MAROON)
        self.welcome_title.pack(side = "top", pady = 2, padx = 0)
        self.assigned_textbooks = tk.Label(self, text = "Textbooks To Go: ", font = controller.TITLE_FONT2, bg = controller.MAROON)
        self.assigned_textbooks.pack(side = "top", pady = 2, padx = 0)
        self.distributed_textbooks = tk.Label(self, text = "Textbooks Distributed: ", font = controller.TITLE_FONT2, bg = controller.MAROON)
        self.distributed_textbooks.pack(side = "top", pady = 2, padx = 0)
        ...
        self.scanning_label.pack(side = "top", pady = 2, padx = 0)
        self.student_listbox = tk.Listbox(self, bd = 0, bg = controller.MAROON, font = controller.ENTRY_FONT, selectmode = "SINGLE", selectbackground = controller.MAROON, height = 15, width = 40)
        self.student_listbox.pack(side = "top", pady = 2, padx = 0)
